...
{
    [Entity(TableCnName = "会员统计", TableName = "DC_MktMemberStatistic", DBServer = "VOLContext")]
    public partial class DC_MktMemberStatistic : BaseEntity
    {
        [Key]
        [Display(Name = "主键ID")]
        ...
        [Column(TypeName = "int")]
        [Editable(true)]
        public int PopUpNumber { get; set; }
