export default {
  table: {
    ...
    columns: [
      ...
      { field: 'PaymentMethod', title: '支付方式', type: 'int', bind: { key: 'payment_method', data: [] }, width: 100, align: 'left' },
      { field: 'Status', title: '状态', type: 'int', bind: { key: 'recharge_status', data: [] }, width: 90, align: 'left' },
