export default {
  table: {
    ...
    columns: [
      ...
      { field: 'Type', title: '类型', type: 'int', bind: { key: 'yuebao_trading_type', data: [] }, width: 100, align: 'left' },
      ...
      { field: 'Profit', title: '收益', type: 'decimal', width: 110, align: 'left' },
