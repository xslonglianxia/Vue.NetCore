export default {
  table: {
    ...
    columns: [
      ...
      { field: 'RechargeNumber', title: '充值笔数', type: 'int', width: 100, align: 'left' },
      { field: 'WithdrawalAmount', title: '提现金额', type: 'decimal', width: 110, align: 'left' },
      { field: 'WithdrawalNumber', title: '提现笔数', type: 'int', width: 100, align: 'left' },
