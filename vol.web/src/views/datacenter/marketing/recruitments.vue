<template>
  <div class="dc-mkt-recruitments">
    ...
    <vol-table
      ...
      :index="true"
    />
    <vol-box v-model="editBoxVisible" title="招聘编辑" :width="650" :height="400">
      <vol-form
        ref="editForm"
...
const url = '/api/DC/DC_MktRecruitment/'
const searchFormFields = reactive({ name: '' })
const searchFormRules = [
  [{ title: '名称', field: 'name', type: 'like' }]
]
const editFormFields = reactive({ name: '', icon: '', salary: 0, number: 0, seq: 0, remark: '' })
const editFormRules = [
  [{ title: '名称', field: 'name', required: true }, { title: '图标', field: 'icon', type: 'img' }],
  [{ title: '薪资', field: 'salary', type: 'number' }, { title: '人数', field: 'number', type: 'number' }],
...
const columns = reactive([
  ...
  { field: 'salary', title: '薪资', type: 'decimal', width: 90 },
  { field: 'number', title: '人数', type: 'int', width: 70 },
...
.dc-mkt-recruitments { padding: 10px; }
