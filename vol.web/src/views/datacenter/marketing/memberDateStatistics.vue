<template>
  <div class="dc-mkt-member-date-statistics">
    <vol-form
      ref="searchForm"
...
const url = '/api/DC/DC_MktMemberDateStatistic/'
const searchFormFields = reactive({ memberUsername: '', dateRange: '' })
...
.dc-mkt-member-date-statistics { padding: 10px; }
</style>
