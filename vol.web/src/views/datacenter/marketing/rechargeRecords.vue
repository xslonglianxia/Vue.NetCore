<template>
  <div class="dc-mkt-recharge-records">
    <vol-form
      ref="searchForm"
...
const url = '/api/DC/DC_MktRechargeRecord/'
...
const columns = reactive([
  ...
  { field: 'kindId', title: '类型', type: 'int', width: 80, bind: { key: 'dc_mkt_recharge_kind', data: [] } },
  ...
  { field: 'realAmount', title: '实际金额', type: 'decimal', width: 100 },
...
.dc-mkt-recharge-records { padding: 10px; }
