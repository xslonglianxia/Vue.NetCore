<template>
  <div class="vol-container">
    ...
    <vol-box v-model="model" :height="300" :width="450" :title="boxTitle">
...
const columns = reactive([
  ...
  { field: 'remark', title: '备注', type: 'string', width: 300 },
...
const resetForm = () => {
  Object.assign(formFields, { name: '', remark: '' })
}
