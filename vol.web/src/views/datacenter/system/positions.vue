<template>
  <div class="vol-container">
    ...
    <vol-box v-model="model" :height="380" :width="500" :title="boxTitle">
...
const url = '/api/DC/DC_SysPosition/'
...
const columns = reactive([
  ...
  { field: 'orgId', title: '组织', type: 'string', width: 150 },
...
const resetForm = () => {
  Object.assign(formFields, { name: '', orgId: null, seq: 0, remark: '' })
}
